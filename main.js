...
.header {
    height: 100px;
    background: linear-gradient(135deg,#05E69C,#E63105 );
}`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;IACI,SAAS;IACT,UAAU;IACV,sBAAsB;AAC1B;;AAEA;IACI,aAAa;IACb,oDAAoD;AACxD","sourcesContent":["*, *::before, *::after {\n    margin: 0;\n    padding: 0;\n    box-sizing: border-box;\n}\n\n.header {\n    height: 100px;\n    background: linear-gradient(135deg,#05E69C,#E63105 );\n}"],"sourceRoot":""}]);
// Exports
